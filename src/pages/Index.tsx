    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative w-full">
        <div className="relative h-[320px] sm:h-[420px] lg:h-[500px] overflow-hidden bg-primary">
          ...
          <div className="absolute inset-0 flex flex-col items-start justify-center text-left px-6 sm:px-10 lg:px-16">
            <h2 className="font-heading font-black text-2xl sm:text-5xl lg:text-6xl text-primary-foreground mb-4 tracking-tight drop-shadow-lg max-w-4xl whitespace-nowrap">AUTENTICA FASHIONF</h2>
      ...
      <section className="container-shop py-10">
        <div className="flex flex-col items-center mb-8 gap-5">
          <img
            src="/images/revendedora-arte.png"
            alt="Arte seja revendedora"
            className="w-full max-w-md sm:max-w-lg lg:max-w-xl h-auto rounded-lg"
            loading="lazy"
          />
          <a href="https://wa.me/5583999618968" target="_blank" rel="noreferrer" className="bg-green-600 text-white font-heading font-bold text-sm sm:text-base px-8 py-4 rounded hover:opacity-90 transition uppercase tracking-wider text-center">Falar no WhatsApp</a>
        </div>
