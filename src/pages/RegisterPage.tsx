...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!acceptedTerms) {
      toast.error('Você precisa concordar com os termos para criar sua conta');
      return;
    }
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-4">
              Cadastre-se para acessar preços exclusivos de atacado
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 bg-card p-8 border border-border rounded-sm">
            ...
            <div className="flex items-start gap-3">
              ...
              <label htmlFor="terms" className="text-sm text-muted-foreground leading-relaxed">
                Li e concordo com os termos de uso e com a política da loja.
              </label>
            </div>
            ...
            <p className="text-center text-sm text-muted-foreground">
              Esqueceu sua senha?{' '}
              <Link to="/redefinir-senha" className="text-primary font-medium hover:text-gold-dark">
                Redefinir senha
              </Link>
            </p>
          </form>
