    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative w-full">
        <div className="relative h-[320px] sm:h-[420px] lg:h-[500px] overflow-hidden bg-primary">
          <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1600&h=600&fit=crop" alt="Banner AUTENTICA FASHIONF" className="w-full h-full object-cover opacity-60" />
